...
//   ]);
// });
Route::match(['get', 'post'], 'factdetection', [App\Http\Controllers\AutoFactController::class, 'factdetection'])->name('fact.factdetection'); //
...
// ***************   Report  Air**********************************
Route::match(['get', 'post'], 'air_setting_month_yokyodauto', [App\Http\Controllers\AirController::class, 'air_setting_month_yokyodauto'])->name('prs.air_setting_month_yokyodauto'); //

// ***************   Report  Fire**********************************
Route::match(['get', 'post'], 'fire_stock_month_ypkyodauto', [App\Http\Controllers\FireController::class, 'fire_stock_month_ypkyodauto'])->name('prs.fire_stock_month_ypkyodauto'); //

// ***************   Report  Gas**********************************
Route::match(['get', 'post'], 'gas_ypkyodauto', [App\Http\Controllers\MedicalgasController::class, 'gas_ypkyodauto'])->name('prs.gas_ypkyodauto'); //

// ***************   Report  Drink**********************************
Route::match(['get', 'post'], 'drinking_count_month', [App\Http\Controllers\DrinkingController::class, 'drinking_count_month'])->name('prs.drinking_count_month'); //
...
Route::match(['get', 'post'], 'pullvisit_new', [App\Http\Controllers\AutoController::class, 'pullvisit_new'])->name('auto.pullvisit_new'); //
Route::match(['get', 'post'], 'pullvisit_authennew', [App\Http\Controllers\AutoController::class, 'pullvisit_authennew'])->name('auto.pullvisit_authennew'); //
...
Route::get('home_supplies_mobile', [App\Http\Controllers\AirController::class, 'home_supplies_mobile'])->name('manage.home_supplies_mobile');
...
Route::get('home_supplies_excel', [App\Http\Controllers\AirController::class, 'home_supplies_excel'])->name('manage.home_supplies_excel')->middleware('type');
  ...
  Route::match(['get', 'post'], 'time_nurs_person', [App\Http\Controllers\TimerController::class, 'time_nurs_person'])->name('t.time_nurs_person'); // ระบบลงเวลา
  Route::match(['get', 'post'], 'time_nurs_personexcel/{id}/{startdate}/{enddate}', [App\Http\Controllers\TimerController::class, 'time_nurs_personexcel'])->name('t.time_nurs_personexcel'); // ระบบลงเวลา
  Route::match(['get', 'post'], 'time_nurs_person_pdf/{id}/{startdate}/{enddate}', [App\Http\Controllers\TimerController::class, 'time_nurs_person_pdf'])->name('t.time_nurs_person_pdf'); // ระบบลงเวลา
  ...
  Route::match(['get', 'post'], 'wh_stock_card_pdf/{idstore}/{idpro}', [App\Http\Controllers\WhController::class, 'wh_stock_card_pdf'])->name('wh.wh_stock_card_pdf'); //
  ...
  Route::match(['get', 'post'], 'wh_product_moadd', [App\Http\Controllers\WhController::class, 'wh_product_moadd'])->name('wh.wh_product_moadd'); //
  Route::match(['get', 'post'], 'wh_product_mosave', [App\Http\Controllers\WhController::class, 'wh_product_mosave'])->name('wh.wh_product_mosave'); //
  Route::match(['get', 'post'], 'wh_product_moedit/{id}', [App\Http\Controllers\WhController::class, 'wh_product_moedit'])->name('wh.wh_product_moedit'); //
  Route::match(['get', 'post'], 'wh_product_moupdate', [App\Http\Controllers\WhController::class, 'wh_product_moupdate'])->name('wh.wh_product_moupdate'); //
  Route::match(['get', 'post'], 'wh_product_subsave', [App\Http\Controllers\WhController::class, 'wh_product_subsave'])->name('wh.wh_product_subsave'); //
  Route::match(['get', 'post'], 'wh_product_subcolorsave', [App\Http\Controllers\WhController::class, 'wh_product_subcolorsave'])->name('wh.wh_product_subcolorsave'); //
  ...
  Route::match(['get', 'post'], 'load_product_sub', [App\Http\Controllers\WhController::class, 'load_product_sub'])->name('wh.load_product_sub'); //
  Route::match(['get', 'post'], 'load_product_subdestroy', [App\Http\Controllers\WhController::class, 'load_product_subdestroy'])->name('wh.load_product_subdestroy'); //
  ...
  Route::match(['get', 'post'], 'wh_mainpay_approve/{id}', [App\Http\Controllers\WhController::class, 'wh_mainpay_approve'])->name('wh.wh_mainpay_approve'); //

  Route::match(['get', 'post'], 'wh_main_pay', [App\Http\Controllers\WhController::class, 'wh_main_pay'])->name('wh.wh_main_pay'); //
  Route::match(['get', 'post'], 'wh_main_paysave', [App\Http\Controllers\WhController::class, 'wh_main_paysave'])->name('wh.wh_main_paysave'); //
  Route::match(['get', 'post'], 'wh_main_payadd/{id}', [App\Http\Controllers\WhController::class, 'wh_main_payadd'])->name('wh.wh_main_payadd'); //
  Route::match(['get', 'post'], 'wh_main_payselect/{id}', [App\Http\Controllers\WhController::class, 'wh_main_payselect'])->name('wh.wh_main_payselect'); //
  Route::match(['get', 'post'], 'wh_mainpay_sublot_save', [App\Http\Controllers\WhController::class, 'wh_mainpay_sublot_save'])->name('wh.wh_mainpay_sublot_save'); //
  Route::match(['get', 'post'], 'load_datapay_table', [App\Http\Controllers\WhController::class, 'load_datapay_table'])->name('wh.load_datapay_table'); //
  Route::match(['get', 'post'], 'wh_main_paydestroy', [App\Http\Controllers\WhController::class, 'wh_main_paydestroy'])->name('wh.wh_main_paydestroy'); //
  Route::match(['get', 'post'], 'wh_main_payaddsave', [App\Http\Controllers\WhController::class, 'wh_main_payaddsave'])->name('wh.wh_main_payaddsave'); //
  Route::match(['get', 'post'], 'wh_main_payedit/{id}', [App\Http\Controllers\WhController::class, 'wh_main_payedit'])->name('wh.wh_main_payedit'); //
  Route::match(['get', 'post'], 'wh_main_payupdate', [App\Http\Controllers\WhController::class, 'wh_main_payupdate'])->name('wh.wh_main_payupdate'); //
  ...
  Route::match(['get', 'post'], 'load_shooping_table', [App\Http\Controllers\WhUserController::class, 'load_shooping_table'])->name('wh.load_shooping_table'); //
  Route::match(['get', 'post'], 'load_shooping_tables', [App\Http\Controllers\WhUserController::class, 'load_shooping_tables'])->name('wh.load_shooping_tables'); //
  Route::match(['get', 'post'], 'wh_request_addsubpicdestroy', [App\Http\Controllers\WhUserController::class, 'wh_request_addsubpicdestroy'])->name('wh.wh_request_addsubpicdestroy'); //

  Route::match(['get', 'post'], 'select_destpic', [App\Http\Controllers\WhUserController::class, 'select_destpic'])->name('wh.select_destpic'); //
  Route::match(['get', 'post'], 'wh_request_picdestroy', [App\Http\Controllers\WhUserController::class, 'wh_request_picdestroy'])->name('wh.wh_request_picdestroy'); //

  Route::match(['get', 'post'], 'wh_picid/{id}', [App\Http\Controllers\WhUserController::class, 'wh_picid'])->name('wh.wh_picid'); //
  Route::match(['get', 'post'], 'wh_picidtwo/{id}', [App\Http\Controllers\WhUserController::class, 'wh_picidtwo'])->name('wh.wh_picidtwo'); //
  ...
  Route::match(['get', 'post'], 'wh_cancel_req/{id}', [App\Http\Controllers\WhUserController::class, 'wh_cancel_req'])->name('wh.wh_cancel_req'); //
  ...
  Route::match(['get', 'post'], 'wh_sub_main_paydetail', [App\Http\Controllers\WhUserController::class, 'wh_sub_main_paydetail'])->name('wh.wh_sub_main_paydetail'); //
  ...
  Route::match(['get', 'post'], 'wh_loadtotal', [App\Http\Controllers\WhUserController::class, 'wh_loadtotal'])->name('wh.wh_loadtotal'); //


  // ******************** ตั้งค่า  คลังพัสดุ ***********************
    Route::match(['get', 'post'], 'wh_confix_store', [App\Http\Controllers\WhController::class, 'wh_confix_store'])->name('wh.wh_confix_store'); //
    Route::match(['get', 'post'], 'wh_confix_store_add', [App\Http\Controllers\WhController::class, 'wh_confix_store_add'])->name('wh.wh_confix_store_add'); //
    Route::match(['get', 'post'], 'wh_confix_storeswitch', [App\Http\Controllers\WhController::class, 'wh_confix_storeswitch'])->name('wh.wh_confix_storeswitch'); //
    Route::match(['get', 'post'], 'wh_confix_store_edit/{id}', [App\Http\Controllers\WhController::class, 'wh_confix_store_edit'])->name('wh.wh_confix_store_edit'); //
    Route::match(['get', 'post'], 'wh_confix_store_save', [App\Http\Controllers\WhController::class, 'wh_confix_store_save'])->name('wh.wh_confix_store_save'); //
    Route::match(['get', 'post'], 'wh_confix_store_update', [App\Http\Controllers\WhController::class, 'wh_confix_store_update'])->name('wh.wh_confix_store_update'); //
  ...
  Route::match(['get', 'post'], 'account_pkti4011_send', [App\Http\Controllers\Account4011Controller::class, 'account_pkti4011_send'])->name('acc.account_pkti4011_send'); //
  ...
  Route::match(['get', 'post'], 'account_pkti4022_send', [App\Http\Controllers\Account4022Controller::class, 'account_pkti4022_send'])->name('acc.account_pkti4022_send'); //
  ...
  Route::match(['get', 'post'], 'upstm_lgo_tiipd', [App\Http\Controllers\AccountPKController::class, 'upstm_lgo_tiipd'])->name('acc.upstm_lgo_tiipd'); //
  Route::match(['get', 'post'], 'upstm_lgo_tiipd_detail/{id}', [App\Http\Controllers\AccountPKController::class, 'upstm_lgo_tiipd_detail'])->name('acc.upstm_lgo_tiipd_detail'); //
  ...
  Route::match(['get', 'post'], 'upstm_sss_excelsend309', [App\Http\Controllers\AccountPKController::class, 'upstm_sss_excelsend309'])->name('acc.upstm_sss_excelsend309'); //
  ...
  Route::match(['get', 'post'], 'acc_106_pull_wait/{months}/{year}', [App\Http\Controllers\Account106Controller::class, 'acc_106_pull_wait'])->name('acc.acc_106_pull_wait'); //
  ...
  Route::match(['get', 'post'], 'acc_106_debtchecksit', [App\Http\Controllers\Account106Controller::class, 'acc_106_debtchecksit'])->name('acc.acc_106_debtchecksit'); //
  ...
  Route::match(['get', 'post'], 'acc_107_debt_syncnew/{months}', [App\Http\Controllers\Account107Controller::class, 'acc_107_debt_syncnew'])->name('acc.acc_107_debt_syncnew'); //
  ...
  Route::match(['get', 'post'], 'acc_107_debtchecksit', [App\Http\Controllers\Account107Controller::class, 'acc_107_debtchecksit'])->name('acc.acc_107_debtchecksit'); //
  Route::match(['get', 'post'], 'acc_107_detail_money/{months}/{year}', [App\Http\Controllers\Account107Controller::class, 'acc_107_detail_money'])->name('acc.acc_107_detail_money'); //
  ...
  Route::match(['get', 'post'], 'account_302_update', [App\Http\Controllers\Account302Controller::class, 'account_302_update'])->name('acc.account_302_update'); //
  ...
  Route::match(['get', 'post'], 'account_309_stm2/{months}/{year}', [App\Http\Controllers\Account309Controller::class, 'account_309_stm2'])->name('acc.account_309_stm2'); //
  ...
  Route::match(['get', 'post'], 'account_401_send', [App\Http\Controllers\Account401Controller::class, 'account_401_send'])->name('acc.account_401_send'); //
  ...
  Route::match(['get', 'post'], 'account_402_send', [App\Http\Controllers\Account402Controller::class, 'account_402_send'])->name('acc.account_402_send'); //
  ...
  Route::match(['get', 'post'], 'account_501_checksit', [App\Http\Controllers\Account501Controller::class, 'account_501_checksit'])->name('acc.account_501_checksit'); //
  ...
  Route::match(['get', 'post'], 'account_502_checksit', [App\Http\Controllers\Account502Controller::class, 'account_502_checksit'])->name('acc.account_502_checksit'); //
  ...
  Route::match(['get', 'post'], 'account_503_search', [App\Http\Controllers\Account503Controller::class, 'account_503_search'])->name('acc.account_503_search'); //
  Route::match(['get', 'post'], 'account_503_checksit', [App\Http\Controllers\Account503Controller::class, 'account_503_checksit'])->name('acc.account_503_checksit'); //
  ...
  Route::match(['get', 'post'], 'account_504_search', [App\Http\Controllers\Account504Controller::class, 'account_504_search'])->name('acc.account_504_search'); //
  Route::match(['get', 'post'], 'account_504_checksit', [App\Http\Controllers\Account504Controller::class, 'account_504_checksit'])->name('acc.account_504_checksit'); //
  ...
  Route::match(['get', 'post'], 'account_602_search', [App\Http\Controllers\Account602Controller::class, 'account_602_search'])->name('acc.account_602_search'); //
  Route::match(['get', 'post'], 'account_602_checksit', [App\Http\Controllers\Account602Controller::class, 'account_602_checksit'])->name('acc.account_602_checksit'); //
  ...
  Route::match(['get', 'post'], 'account_603_search', [App\Http\Controllers\Account603Controller::class, 'account_603_search'])->name('acc.account_603_search'); //
  Route::match(['get', 'post'], 'account_603_checksit', [App\Http\Controllers\Account603Controller::class, 'account_603_checksit'])->name('acc.account_603_checksit'); //
  ...
  Route::match(['get', 'post'], 'account_701_checksit', [App\Http\Controllers\Account701Controller::class, 'account_701_checksit'])->name('acc.account_701_checksit'); //
  ...
  Route::match(['get', 'post'], 'account_701_search', [App\Http\Controllers\Account701Controller::class, 'account_701_search'])->name('acc.account_701_search'); //
  ...
  Route::match(['get', 'post'], 'account_701_destroy', [App\Http\Controllers\Account701Controller::class, 'account_701_destroy'])->name('acc.account_701_destroy'); //
  ...
  Route::match(['get', 'post'], 'account_702_search', [App\Http\Controllers\Account702Controller::class, 'account_702_search'])->name('acc.account_702_search'); //
  Route::match(['get', 'post'], 'account_702_checksit', [App\Http\Controllers\Account702Controller::class, 'account_702_checksit'])->name('acc.account_702_checksit'); //
  ...
  Route::match(['get', 'post'], 'account_704_search', [App\Http\Controllers\Account704Controller::class, 'account_704_search'])->name('acc.account_704_search'); //
  Route::match(['get', 'post'], 'account_704_checksit', [App\Http\Controllers\Account704Controller::class, 'account_704_checksit'])->name('acc.account_704_checksit'); //
  ...
  Route::match(['get','post'],  'account_801_send',[App\Http\Controllers\Account801Controller::class, 'account_801_send'])->name('acc.account_801_send');//
//   Route::match(['get','post'],  'account_rep_801',[App\Http\Controllers\Account801Controller::class, 'account_rep_801'])->name('acc.account_rep_801');//
  ...
  Route::match(['get', 'post'], 'account_802_send', [App\Http\Controllers\Account802Controller::class, 'account_802_send'])->name('acc.account_802_send'); //
  ...
  Route::match(['get', 'post'], 'account_803_send', [App\Http\Controllers\Account803Controller::class, 'account_803_send'])->name('acc.account_803_send'); //
  ...
  Route::match(['get', 'post'], 'account_804_send', [App\Http\Controllers\Account804Controller::class, 'account_804_send'])->name('acc.account_804_send'); //.

  Route::match(['get', 'post'], 'kontoon_imc_dash', [App\Http\Controllers\AccountIMCController::class, 'kontoon_imc_dash'])->name('acc.kontoon_imc_dash'); //
  Route::match(['get', 'post'], 'kontoon_imc_pull', [App\Http\Controllers\AccountIMCController::class, 'kontoon_imc_pull'])->name('acc.kontoon_imc_pull'); //
  Route::match(['get', 'post'], 'kontoon_imc_checksit', [App\Http\Controllers\AccountIMCController::class, 'kontoon_imc_checksit'])->name('acc.kontoon_imc_checksit'); //
  Route::match(['get', 'post'], 'kontoon_imc_pulldata', [App\Http\Controllers\AccountIMCController::class, 'kontoon_imc_pulldata'])->name('acc.kontoon_imc_pulldata'); //
  Route::match(['get', 'post'], 'kontoon_imc_stam', [App\Http\Controllers\AccountIMCController::class, 'kontoon_imc_stam'])->name('acc.kontoon_imc_stam'); //
  Route::match(['get', 'post'], 'kontoon_imc_stm/{months}/{year}', [App\Http\Controllers\AccountIMCController::class, 'kontoon_imc_stm'])->name('acc.kontoon_imc_stm'); //
  Route::match(['get', 'post'], 'kontoon_imc_destroy', [App\Http\Controllers\AccountIMCController::class, 'kontoon_imc_destroy'])->name('acc.kontoon_imc_destroy'); //
  Route::match(['get', 'post'], 'kontoon_imc_up', [App\Http\Controllers\AccountIMCController::class, 'kontoon_imc_up'])->name('acc.kontoon_imc_up'); //
  Route::match(['get', 'post'], 'kontoon_imc_save', [App\Http\Controllers\AccountIMCController::class, 'kontoon_imc_save'])->name('acc.kontoon_imc_save'); //
  Route::match(['get', 'post'], 'kontoon_imc_send', [App\Http\Controllers\AccountIMCController::class, 'kontoon_imc_send'])->name('acc.kontoon_imc_send'); //
  Route::match(['get', 'post'], 'kontoon_imc_detail/{months}/{year}', [App\Http\Controllers\AccountIMCController::class, 'kontoon_imc_detail'])->name('acc.kontoon_imc_detail'); //
  ...
  Route::match(['get', 'post'], 'account_totalrep_detail/{id}/{months}/{year}', [App\Http\Controllers\AccbController::class, 'account_totalrep_detail'])->name('accb.account_totalrep_detail'); //
  ...
  Route::match(['get', 'post'], 'account_rep_801', [App\Http\Controllers\AccbController::class, 'account_rep_801'])->name('accb.account_rep_801'); //
  Route::match(['get', 'post'], 'account_rep_802', [App\Http\Controllers\AccbController::class, 'account_rep_802'])->name('accb.account_rep_802'); //
  Route::match(['get', 'post'], 'account_rep_803', [App\Http\Controllers\AccbController::class, 'account_rep_803'])->name('accb.account_rep_803'); //
  Route::match(['get', 'post'], 'account_rep_804', [App\Http\Controllers\AccbController::class, 'account_rep_804'])->name('accb.account_rep_804'); //

  Route::match(['get', 'post'], 'account_rep_4011', [App\Http\Controllers\AccbController::class, 'account_rep_4011'])->name('accb.account_rep_4011'); //
  Route::match(['get', 'post'], 'account_rep_4022', [App\Http\Controllers\AccbController::class, 'account_rep_4022'])->name('accb.account_rep_4022'); //
...
//   Route::match(['get', 'post'], 'account_nopaid_sub/{startdate}/{enddate}', [App\Http\Controllers\AccountController::class, 'account_nopaid_sub'])->name('acc.account_nopaid_sub'); //
  Route::match(['get', 'post'], 'account_nopaid_sub/{startdate}', [App\Http\Controllers\AccountController::class, 'account_nopaid_sub'])->name('acc.account_nopaid_sub'); //
...
//   Route::match(['get', 'post'], 'account_nopaid_sub_ip/{months}/{year}', [App\Http\Controllers\AccountController::class, 'account_nopaid_sub_ip'])->name('acc.account_nopaid_sub_ip'); //
  Route::match(['get', 'post'], 'account_nopaid_sub_ip/{dchdate}', [App\Http\Controllers\AccountController::class, 'account_nopaid_sub_ip'])->name('acc.account_nopaid_sub_ip'); //
...
Route::match(['get','post'],'env_water_add_pond4/{id}',[App\Http\Controllers\EnvController::class, 'env_water_add_pond4'])->name('env.env_water_add_pond4');//น้ำประปา
Route::match(['get','post'],'env_water_add_pond4_save',[App\Http\Controllers\EnvController::class, 'env_water_add_pond4_save'])->name('env_water_add_pond4_save');//บันทึกน้ำประปา
...
Route::match(['get','post'],'env_trash_parameter_switchactive',[App\Http\Controllers\EnvController::class, 'env_trash_parameter_switchactive'])->name('env.env_trash_parameter_switchactive');//สถานะ
  ...
  Route::match(['get', 'post'], 'fire_report_month_pdf', [App\Http\Controllers\FireController::class, 'fire_report_month_pdf'])->name('prs.fire_report_month_pdf'); //
  ...
  Route::match(['get', 'post'], 'fire_stock', [App\Http\Controllers\FireController::class, 'fire_stock'])->name('prs.fire_stock'); //
  Route::match(['get', 'post'], 'fire_stock_add', [App\Http\Controllers\FireController::class, 'fire_stock_add'])->name('prs.fire_stock_add'); //
  Route::match(['get', 'post'], 'fire_stock_save', [App\Http\Controllers\FireController::class, 'fire_stock_save'])->name('prs.fire_stock_save'); //
  Route::match(['get', 'post'], 'fire_stock_edit/{id}', [App\Http\Controllers\FireController::class, 'fire_stock_edit'])->name('prs.fire_stock_edit'); //
  Route::match(['get', 'post'], 'fire_stock_update', [App\Http\Controllers\FireController::class, 'fire_stock_update'])->name('prs.fire_stock_update'); //
  Route::match(['get', 'post'], 'fire_stock_addsub/{id}', [App\Http\Controllers\FireController::class, 'fire_stock_addsub'])->name('prs.fire_stock_addsub'); //
  Route::match(['get', 'post'], 'fire_stock_addsub_save', [App\Http\Controllers\FireController::class, 'fire_stock_addsub_save'])->name('prs.fire_stock_addsub_save'); //
  Route::match(['get', 'post'], 'load_data_tablefire', [App\Http\Controllers\FireController::class, 'load_data_tablefire'])->name('prs.load_data_tablefire'); //
  Route::match(['get', 'post'], 'load_datafire_lot_no', [App\Http\Controllers\FireController::class, 'load_datafire_lot_no'])->name('prs.load_datafire_lot_no'); //
  Route::match(['get', 'post'], 'load_datafire_sum', [App\Http\Controllers\FireController::class, 'load_datafire_sum'])->name('prs.load_datafire_sum'); //
  Route::match(['get', 'post'], 'fire_stock_addsub_update', [App\Http\Controllers\FireController::class, 'fire_stock_addsub_update'])->name('prs.fire_stock_addsub_update'); //
  ...
  Route::match(['get', 'post'], 'air_report_monthpdfsearch/{id}', [App\Http\Controllers\AirController::class, 'air_report_monthpdfsearch'])->name('prs.air_report_monthpdfsearch'); //
  Route::match(['get', 'post'], 'air_report_monthpdfchoi/{id}', [App\Http\Controllers\AirController::class, 'air_report_monthpdfchoi'])->name('prs.air_report_monthpdfchoi'); //
  ...
  Route::match(['get', 'post'], 'gas_stocklist', [App\Http\Controllers\MedicalgasController::class, 'gas_stocklist'])->name('prs.gas_stocklist'); //
  Route::match(['get', 'post'], 'gas_stocklist_add', [App\Http\Controllers\MedicalgasController::class, 'gas_stocklist_add'])->name('prs.gas_stocklist_add'); //
  Route::match(['get', 'post'], 'gas_stocklist_save', [App\Http\Controllers\MedicalgasController::class, 'gas_stocklist_save'])->name('prs.gas_stocklist_save'); //
  Route::match(['get', 'post'], 'gas_stocklist_edit/{id}', [App\Http\Controllers\MedicalgasController::class, 'gas_stocklist_edit'])->name('prs.gas_stocklist_edit'); //
  Route::match(['get', 'post'], 'gas_stocklist_update', [App\Http\Controllers\MedicalgasController::class, 'gas_stocklist_update'])->name('prs.gas_stocklist_update'); //
  Route::match(['get', 'post'], 'gas_stocklist_addsub/{id}', [App\Http\Controllers\MedicalgasController::class, 'gas_stocklist_addsub'])->name('prs.gas_stocklist_addsub'); //
  Route::match(['get', 'post'], 'gas_stocklist_addsub_save', [App\Http\Controllers\MedicalgasController::class, 'gas_stocklist_addsub_save'])->name('prs.gas_stocklist_addsub_save'); //
  Route::match(['get', 'post'], 'gas_stocklist_destrouy', [App\Http\Controllers\MedicalgasController::class, 'gas_stocklist_destrouy'])->name('gas_stocklist_destrouy'); //
  Route::match(['get', 'post'], 'gas_stocklist_updatestock', [App\Http\Controllers\MedicalgasController::class, 'gas_stocklist_updatestock'])->name('prs.gas_stocklist_updatestock'); //

  Route::match(['get', 'post'], 'load_gasdata_table', [App\Http\Controllers\MedicalgasController::class, 'load_gasdata_table'])->name('prs.load_gasdata_table'); //
  Route::match(['get', 'post'], 'load_gasdata_lot_no', [App\Http\Controllers\MedicalgasController::class, 'load_gasdata_lot_no'])->name('prs.load_gasdata_lot_no'); //
  Route::match(['get', 'post'], 'load_gasdata_sum', [App\Http\Controllers\MedicalgasController::class, 'load_gasdata_sum'])->name('prs.load_gasdata_sum'); //
  ...
  Route::match(['get', 'post'], 'report_gas', [App\Http\Controllers\MedicalgasController::class, 'report_gas'])->name('prs.report_gas'); //
  Route::match(['get', 'post'], 'report_gas_check_tank', [App\Http\Controllers\MedicalgasController::class, 'report_gas_check_tank'])->name('prs.report_gas_check_tank'); //
  Route::match(['get', 'post'], 'report_gas_check_tanksub', [App\Http\Controllers\MedicalgasController::class, 'report_gas_check_tanksub'])->name('prs.report_gas_check_tanksub'); //
  Route::match(['get', 'post'], 'report_gas_check_nitrus', [App\Http\Controllers\MedicalgasController::class, 'report_gas_check_nitrus'])->name('prs.report_gas_check_nitrus'); //
  Route::match(['get', 'post'], 'report_gas_check_o2', [App\Http\Controllers\MedicalgasController::class, 'report_gas_check_o2'])->name('prs.report_gas_check_o2'); //
  Route::match(['get', 'post'], 'report_gas_check_control', [App\Http\Controllers\MedicalgasController::class, 'report_gas_check_control'])->name('prs.report_gas_check_control'); //
