...
@forelse ($datashow as $item)
                          ...
                          <table style="width: 100%;">
                              <thead>                               
                                    <tr style="font-size: 11px;height: 11px;color:rgb(65, 63, 63)" class="text-center">    
                                      {{-- <th rowspan="2" style="border: 1px solid rgb(250, 214, 159);width: 4%;background-color: rgb(252, 237, 219);color:#252424">ลำดับ</th>                          --}}
        ...
        @endif        
                              ...
                              <tr>     
                                    ...
                                    <td class="text-center" style="border: 1px solid rgb(250, 232, 221);font-size: 11px;" width="5%">{{$item->recieve_po_sup}}</td>
                          ...
                          @endif
                              ...
                              @php
                                  ...
                                  $count = 0;
                              @endphp
           {{-- @if ($loop->iteration % $row_in_table == 0) --}}
