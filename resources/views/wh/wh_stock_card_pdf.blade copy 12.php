        ...
        @if ($loop->iteration % $row_in_table == 1)
               <div class="row">
                <div class="col-md-12">
                    ...
                    <tr>
                      <th width="20%"></th>
                      <th class="text-center" width="50%"><label for="" style="font-size:14px;"><b>บัญชีวัสดุ</b></label></th>
                      <th width="20%"></th>
                    </tr>  
                  </table>
                  {{-- <table class="table-sm" style="width: 100%;">
                    <tr>
                      <th width="50%"></th>
                      <th class="text-end" width="50%"><label for="" style="font-size:13px;"><b>โรงพยาบาลภูเขียวเฉลิมพระเกียรติ</b></label></th>                    
                    </tr>  
                  </table> --}}
                  <table class="table-sm" style="width: 100%;">
                    <tr>                  
                      <th class="text-start" width="10%"><label for="" style="font-size:13px;"><b>แผ่นที่ </b></label></th>  
                      {{-- <th width="50%"></th>    --}}
                      <th class="text-end" width="90%"><label for="" style="font-size:13px;"><b>โรงพยาบาลภูเขียวเฉลิมพระเกียรติ</b></label></th>                  
                    </tr>  
                  </table>
                  <table class="table-sm" style="width: 100%;">
                      <tr>                  
                          <th class="text-start" width="20%"><label for="" style="font-size:13px;"><b>ประเภท </b>{{$protype}}</label></th>  
                          <th class="text-center" width="67%"><label for="" style="font-size:13px;"><b>ชื่อหรือชนิดวัสดุ </b>{{$pro_name}}</label></th>           
                          <th class="text-start" width="13%"><label for="" style="font-size:13px;"><b>รหัส </b>{{$pro_code}}</label></th>         
                      </tr>                    
                    </table>
                    <table class="table-sm" style="width: 100%;">   
                      <tr>               
                          <th class="text-start" width="87%"><label for="" style="font-size:13px;"><b>ขนาดหรือลักษณะ </b>{{$pro_detail}}</label></th>  
                          <th class="text-start" width="13%"><label for="" style="font-size:13px;"><b>จำนวนอย่างสูง </b>{{$pro_highly}}</label></th>         
                      </tr> 
                  </table>
                  <table class="table-sm" style="width: 100%;">   
                    <tr>               
                        <th class="text-start" width="87%"><label for="" style="font-size:13px;"><b>หน่วยที่นับ </b>{{$wh_unit_name}}</label></th>  
                        <th class="text-start" width="13%"><label for="" style="font-size:13px;"><b>จำนวนอย่างต่ำ </b>{{$pro_atleast}}</label></th>         
                    </tr> 
                </table>
          ...
          @endif                           
                              <tr>
                                    <td class="text-center" style="border: 1px solid rgb(250, 232, 221);font-size: 11px;" width="5%"><span class="badge" style="font-size: 12px;">{{DateThai($item->recieve_date)}}</span></td>
                                    <td class="text-start" style="border: 1px solid rgb(250, 232, 221);font-size: 12px;"><span class="badge" style="font-size: 12px;">&nbsp;รับจาก&nbsp;{{$item->supplies_namesub}}</span></td>
                                    <td class="text-center" style="border: 1px solid rgb(250, 232, 221);font-size: 11px;" width="5%"><span class="badge" style="font-size: 12px;">{{$item->recieve_po_sup}}</span></td>
                                    <td class="text-center" style="border: 1px solid rgb(250, 232, 221);font-size: 11px;" width="4%"><span class="badge" style="font-size: 12px;">{{$item->one_price}}</span></td>
                                    <td class="text-center" style="border: 1px solid rgb(250, 232, 221);font-size: 11px;" width="4%"><span class="badge" style="font-size: 12px;">{{$item->qty}}</span></td> 
                                    ...
                                    <td class="text-center" style="border: 1px solid rgb(250, 232, 221);font-size: 11px;" width="4%">                                    
                                            <span class="badge" style="font-size: 12px;">{{$item->total_allqty}}</span>                                        
                                    </td> 
                                    <td class="text-center" style="border: 1px solid rgb(250, 232, 221);font-size: 11px;" width="4%"><span class="badge" style="font-size: 12px;">{{number_format($item->total_allprice, 2)}}</span></td> 
                                    <td class="text-center" style="border: 1px solid rgb(250, 232, 221);font-size: 11px;" width="10%"><span class="badge" style="font-size: 12px;">LOT: {{$item->lot_no}}</span></td> 
                              </tr>  
                              ...
                              @foreach ($datashow2 as $item2) 
                                    ...
                                    @endif --}}
                                            <tr>
                                                ...
                                                <td class="text-center" style="border: 1px solid rgb(250, 232, 221);font-size: 11px;" width="5%">{{$item2->request_no}}</td>
...
<script type="text/php">
  if ( isset($pdf) ) {
      $pdf->page_text(65, 67, " {PAGE_NUM}",null, 10, array(255,0,0));
  }
</script>
{{-- <script type="text/php">
  if ( isset($pdf) ) {
