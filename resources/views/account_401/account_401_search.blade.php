...
?>
    ...
    <div class="tabs-animation">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="card-title" style="color:rgb(247, 31, 95)">Search Detail 1102050101.401</h4>
        ...
        <form action="{{ URL('account_401_search') }}" method="GET">
            @csrf
        <div class="row">
            <div class="col-md-4">
                <h5 class="card-title" style="color:rgb(247, 31, 95)">Search Detail 1102050101.401</h5>
                <p class="card-title-desc">ค้นหาลูกหนี้ ผัง 1102050101.401</p>
            </div>
            <div class="col"></div>
                        ...
                        <table id="datatable-buttons" class="table table-sm table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" >ApproveCode</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($datashow as $item)
                                    ...
                                    <tr height="20" style="font-size: 14px;">
                                        ...
                                        <td class="text-center" width="5%"><input type="checkbox" class="dcheckbox_ sub_chk" data-id="{{$item->acc_1102050101_401_id}}"> </td>
                                        ...
                                        <td class="text-center" style="color:rgb(4, 82, 172)" width="6%">{{ number_format($item->rep_pay,2)}}</td>
                                        <td class="text-center" style="color:rgb(4, 132, 141)" width="6%">{{ number_format($item->stm_money,2)}}</td>
                                        <td class="text-start" width="9%">
                                            @if ($item->STMDoc =='')
                                            {{ $item->rep_doc }}
                                            @else
                                            {{ $item->STMDoc }}
                                ...
                                @endforeach
                                        ...
                                        <tr style="background-color: #f3fca1">
                                            <td colspan="11" class="text-center" style="background-color: #ff9d9d"></td>
                                            ...
                                            <td class="text-center" style="background-color: #059b75;color: #078d9e">{{ number_format($total8,2)}}</td>
