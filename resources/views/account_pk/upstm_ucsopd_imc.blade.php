            ...
            <div class="col-xl-8 col-md-6">
                <div class="card cardacc">
                    <div class="grid-menu-col">
                        <form method="POST" action="{{ route('acc.upstm_ucsopd_imcsave') }}" enctype="multipart/form-data"> 
                            @csrf
                            <div class="row">
                                <div class="col"></div>
                                <div class="col-md-8">
                                    <div class="mb-3 mt-3">
                                        <label for="file" class="form-label">UP STM EXCEL OPD IMC=> UP STM => ส่งข้อมูล</label>
                                        <input class="form-control form-control-lg" id="file_stm" name="file_stm" type="file" required>
                                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    </div>
                                    @if ($countc > 0)
                                        <a href="{{ url('upstm_ucsopd_imcsend') }}" class="mb-3 me-2 btn-icon btn-shadow btn-dashed btn btn-outline-primary">
                            ...
                            <tbody>
                                ...
                                @foreach ($datashow as $item)
                                    ...
                                    <tr height="20" style="font-size: 14px;color:rgb(235, 6, 6)">
                                        ...
                                        <td class="text-center" width="10%" style="color:rgb(248, 12, 12)"> {{ $item->rep_no }}</td>
                                        @if ($item->months == '1')
