        ...
        <form action="{{ url('account_301_dash') }}" method="GET">
            ...
            <div class="row mt-2">
                ...
                <div class="col-md-6 text-start">
                    <h4 class="card-title" style="color:rgb(247, 31, 95)">Detail SSS OPD</h4>
                        ...
                        <table id="example2" class="table table-striped table-bordered dt-responsive nowrap myTable" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" style="background-color: rgb(135, 190, 253)">ต้องตั้ง-All</th>
                                    <th class="text-center" style="background-color: rgb(135, 190, 253)">ตั้งลูกหนี้-All</th>
                                    <th class="text-center" style="background-color: rgb(135, 190, 253)">Stm-All</th>
                                    <th class="text-center" style="background-color: rgb(250, 225, 234)">ยกยอดไป</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php $numbernew = 0; $total1 = 0; $total2 = 0; $total3 = 0; $total4 = 0; $total5 = 0;$total6 = 0;$total7 = 0;$total8 = 0;$total9 = 0;$total10 = 0;$total11 = 0; ?>
                                @foreach ($datashow as $itemnew)
                                    <?php
                                        $numbernew++;
                                        $ys = date('Y') + 543;
                                        $ysnew = $ys + 543;
                    ...
                    <div class="table-responsive p-3">
                        <table id="example" class="table table-sm table-striped table-bordered dt-responsive nowrap myTable" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tr style="background-color: #f3fca1">
                                ...
                                <td class="text-end" style="background-color: #6842f1"><label for="" style="color: #000000">{{ number_format($total2, 2) }}</label></td>
                                <td class="text-end" style="background-color: #9f4efc" ><label for="" style="color: #000000">{{ number_format($total3, 2) }}</label></td>
                                <td class="text-end" style="background-color: #10aaa2"><label for="" style="color: #000000">{{ number_format($total4, 2) }}</label></td>
                                ...
                                <td class="text-end" style="background-color: #073bac"><label for="" style="color: #000000">{{ number_format($total8, 2) }}</label></td>
                                <td class="text-end" style="background-color: #5407ac"><label for="" style="color: #000000">{{ number_format($total9, 2) }}</label></td>
                                <td class="text-end" style="background-color: #07ac7a"><label for="" style="color: #000000">0.00</label></td>
                                <td class="text-end" style="background-color: #fc6b17"><label for="" style="color: #000000">0.00</label></td>
