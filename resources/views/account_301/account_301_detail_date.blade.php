...
{{--
    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
        <h5 class="card-title" style="color:rgb(248, 28, 83)">Detail Pang 1102050101.301</h5>
    ...
    <form action="{{ url('account_301_detail_date') }}" method="GET">
        ...
        <div class="row">
            <div class="col-md-4">
                <h4 class="card-title" style="color:rgb(248, 28, 83)">Detail 1102050101.301</h4>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                                    ...
                                    @foreach ($data as $item)
                                        <?php $number++; ?>
                                            ...
                                            <tr height="20" style="font-size: 14px;">
                                                ...
                                                <td class="text-center" style="color:rgb(131, 6, 93)" width="5%">{{ $item->stm_no }}</td>
                                ...
                                <tr style="background-color: #f3fca1">
                                    ...
                                    <td colspan="3" class="text-end" style="background-color: #ff9d9d"></td>
                                </tr>
                            </table>
                        </div>
                    </div>
